 ...
 */
export const useConfig = <K extends ConfigSecionKey>(section: K) => defineConfigs<typeof iconifyDefaults[K]>(section, iconifyDefaults[section]);
/**
 * Define configurations of an extension. See `vscode::workspace.getConfiguration`.
 */
export const useConfigObject = <K extends ConfigSecionKey>(section: K) => defineConfigObject<typeof iconifyDefaults[K]>(section, iconifyDefaults[section]);
/**
