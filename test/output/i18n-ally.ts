...
/**
  ...
  const oldVal:object = parsers.extendFileExtensions //get value
  parsers.$update("extendFileExtensions", oldVal) //update value
 */
/**
  //ToConfigRefs<Parsers> of `i18n-ally.parsers`
  //@example parsers
  const parsers = useConfigParsers()
  const oldVal:object = parsers.extendFileExtensions.value //get value
  parsers.extendFileExtensions.update(oldVal) //update value
 */
/**
