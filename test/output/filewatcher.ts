...
export type CommandKey = 
  ...
  | "extension.disableFileWatcher"
  | "extension.focusIntoOutput"
...
export function useCommandExtensionEnableFileWatcher(callback: (...args: any[]) => any) {
  return useCommandBase("extension.enableFileWatcher", callback)
}
...
export function useCommandExtensionDisableFileWatcher(callback: (...args: any[]) => any) {
  return useCommandBase("extension.disableFileWatcher", callback)
}
...
export function useCommandExtensionFocusIntoOutput(callback: (...args: any[]) => any) {
  return useCommandBase("extension.focusIntoOutput", callback)
}
