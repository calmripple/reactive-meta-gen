...
/**
 * ConfigObject<Filewatcher> of `filewatcher`
 */
export const useConfigObjectFilewatcher = () => useConfigObject(configs.filewatcher);
/**
 * ToConfigRefs<Filewatcher> of `filewatcher`
 */
...
//ConfigObject<Filewatcher> of `filewatcher`
//@example filewatcher
const filewatcher = meta.useConfigObjectFilewatcher()
const oldVal:boolean = filewatcher.autoClearConsole //get value
filewatcher.$update("autoClearConsole", oldVal, ConfigurationTarget.Global) //update value
 */
/**
//ToConfigRefs<Filewatcher> of `filewatcher`
//@example filewatcher
const filewatcher = meta.useConfigFilewatcher()
const oldVal:boolean = filewatcher.autoClearConsole.value //get value
filewatcher.autoClearConsole.update(oldVal, ConfigurationTarget.Global) //update value
 */ 
