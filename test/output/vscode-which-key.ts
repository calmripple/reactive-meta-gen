...
//ConfigObject<Whichkey> of `whichkey`
//@example whichkey
const whichkey = meta.useConfigObjectWhichkey()
const oldVal:object = whichkey.transient //get value
whichkey.$update("transient", oldVal, ConfigurationTarget.Global) //update value
 */
/**
//ToConfigRefs<Whichkey> of `whichkey`
//@example whichkey
const whichkey = meta.useConfigWhichkey()
const oldVal:object = whichkey.transient.value //get value
whichkey.transient.update(oldVal, ConfigurationTarget.Global) //update value
 */ 
