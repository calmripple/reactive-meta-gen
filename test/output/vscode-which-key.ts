 ...
 */
export type Command = "whichkey.show";
/**
...
export const commandsInformation = {
     ...
     * @command `whichkey.show`
     */
    "whichkey.show": { "commandShorthandName": "show", "command": "whichkey.show", "title": "Show Menu", "category": "Which Key" },
 ...
 */
export const useConfig = memo(<Section extends ConfigurationSection>(section: Section) => defineConfigs<typeof whichkeyDefaults[Section]>(section, whichkeyDefaults[section]));
/**
 * Define configurations of an extension. See `vscode::workspace.getConfiguration`.
 */
export const useConfigObject = memo(<Section extends ConfigurationSection>(section: Section) => defineConfigObject<typeof whichkeyDefaults[Section]>(section, whichkeyDefaults[section]));
/**
